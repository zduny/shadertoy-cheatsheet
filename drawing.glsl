void drawDisk(in vec2 fragmentCoordinates, in vec2 center, in float radius, in vec4 color, inout vec4 outputColor) {
...
void drawSegment(in vec2 fragmentCoordinates, in vec2 a, in vec2 b, in float thickness, in vec4 color, inout vec4 outputColor)
{
